...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  footerSocialLinks: [],
  contactHeroTitle: "Get in Touch with Turkish Rug House",
  contactHeroDescription: "Have a question about a rug, need help with sizing, or want to know more about a specific piece? Our team is here to help. We typically respond within 24 hours.",
  contactLocationLabel: "",
  contactLocationUrl: "",
  contactTeamCardTitle: "30 Years of Rug Expertise",
  contactTeamCardCtaLabel: "View Our Collection",
  contactTeamCardCtaUrl: "/shop",
