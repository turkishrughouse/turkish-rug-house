...
export default async function DealerLoginPage() {
  const sessionUser = await getSessionUser("dealer")
  if (
    sessionUser &&
    isAdminRole(sessionUser.role) &&
    canAccessPortal(sessionUser, "dealer")
  ) {
        ...
        <div className="flex items-center justify-center px-6 py-10 lg:px-12">
          <div className="w-full max-w-md rounded-3xl border border-[#dce3ed] bg-white p-8 shadow-[0_24px_80px_rgba(15,23,42,0.12)]">
            <div className="mb-8">
              ...
              <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900">Dealer Login</h1>
              <p className="mt-2 text-sm text-slate-600">
                Sign in to access dealer inventory and wholesale order visibility.
              </p>
            </div>
