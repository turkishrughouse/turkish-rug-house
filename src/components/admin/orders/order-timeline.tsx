                    ...
                    {events.map((event, index) => {
                        ...
                        return (
                            <div key={event.id} className="relative pl-10 group">
                                {/* Icon Bubble */}
                                <div className={cn(
                                    "absolute left-0 top-1 w-8 h-8 rounded-full border-2 bg-white dark:bg-slate-950 flex items-center justify-center z-10 transition-colors",
                                    colorClass
                                )}>
                                ...
                                <div className="flex flex-col gap-1">
                                    <div className="flex items-center justify-between">
                                        <span className="font-medium text-sm text-slate-900 dark:text-slate-100 group-hover:text-teal-600 transition-colors">
                                            {event.title}
                                        </span>
                                    ...
                                    <div className="flex items-center gap-1.5 mt-1">
                                        <span className="inline-flex items-center gap-1 text-[10px] uppercase tracking-wider font-semibold text-slate-400 bg-slate-100 dark:bg-slate-900 px-1.5 py-0.5 rounded">
